...
export const successIcon = findIconDefinition({ prefix: 'fas', iconName: 'check' })!;
export const errorIcon = findIconDefinition({ prefix: 'fas', iconName: 'xmark' })!;
export const expandIcon = findIconDefinition({ prefix: 'fas', iconName: 'expand' })!;
export const compressIcon = findIconDefinition({ prefix: 'fas', iconName: 'compress' })!;
